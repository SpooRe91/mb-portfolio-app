...
export const ICON_NAMES_URLS = [
	{
		name: 'JavaScript',
		extUrl: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript',
	},
	...
	{
		name: 'css3',
		extUrl: 'https://developer.mozilla.org/en-US/docs/Web/CSS',
	},
	{ name: 'Tailwind', extUrl: 'https://tailwindcss.com/docs' },
	{ name: 'SASS', extUrl: 'https://sass-lang.com/guide' },
	{
		name: 'HTML5',
		extUrl: 'https://developer.mozilla.org/en-US/docs/Web/HTML',
	},
	{
		name: 'MaterialUI',
		extUrl: 'https://mui.com/getting-started/installation/',
	},
	{
		name: 'Redux',
		extUrl: 'https://redux.js.org/introduction/getting-started',
	},
