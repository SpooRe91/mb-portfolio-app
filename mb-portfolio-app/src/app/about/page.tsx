    ...
    return (
        <section className="z-[10] relative flex flex-col items-center text-about-text-color p-6 md:min-h-screen-h-md sm:min-h-screen-h-sm sm:p-[0.8rem] sm:gap-[0.5rem]">
            <div className="flex flex-wrap gap-5 flex-col align-middle items-center max-w-4xl bg-bg-transparent-black-main p-[1.25rem] rounded-[5px] shadow-box-shadow-dark">
                ...
                <p className={`text-left md:text-lg sm:text-sm sm:[word-spacing:-3.5px]`}>
            ...
            <div>
                ...
                ></TextBlock>
                <div className="max-w-4xl w-850px w-max-[850px] bg-bg-transparent-black-main rounded-[8px] mb-[15rem] shadow-box-shadow-dark">
                    <div className="flex flex-row flex-wrap p-[1rem] justify-center gap-[1rem] w-full max-w-[750px]">
                        {iconList.map(({ src, name, extUrl }, i) => (
                            <IconsContainer
                                key={i}
                                src={src}
                                name={name}
                                extUrl={extUrl}
                                imgClassname={`w-full h-full ${name === "GitHub" && "brightness-[10]"}`}
